...
public class IdUtil {
    ...
    private long twepoch = 1562288936184L;                              //  Thu, 04 Nov 2010 01:42:54 GMT 标记时间 用来计算偏移量，距离当前时间不同，得到的数据的位数也不同
    ...
    public static Long getId(){
        Long id = IdUtil.get().nextId();
        return id;
    }

    public static void main(String[] args) {
        System.out.println(getId());
        System.out.println("1090898337793572864".length());
    }
}
